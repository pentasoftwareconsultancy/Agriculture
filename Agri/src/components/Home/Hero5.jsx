    ...
    <section className="bg-[#fbfaf5]">
      ...
      <div className="bg-[#1c1b17] py-6 md:py-12">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-4 md:gap-8 text-center text-gray-300">
      ...
      <div className="relative py-10 md:py-16 lg:py-24 overflow-hidden">
        <img
